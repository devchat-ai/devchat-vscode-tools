...
@click.option("--all", help="Remove all the python envs of workflows.", is_flag=True)
def remove(env_name: Optional[str] = None, all: bool = False):
    if not env_name and not all:
